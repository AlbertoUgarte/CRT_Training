...
*** Settings ***
Resource                   ../Regression_1/tests/resources/common.robot
...
Entering A Lead
    ...
    VerifyElementText      Status            New         anchor=Case Origin
    VerifyField            Case Number                 00001029
    VerifyField            Status                      New
    VerifyField            Account Name                Copako
    ClickText              Leads
